 ...
 */
export function getThaiFrequency(word) {
 ...
 */
export function getThaiFrequencyEntry(word) {
 ...
 */
export function categorizeFrequency(rank) {
    if (rank <= 1000)
        return "very-common";
    if (rank <= 5000)
        return "common";
...
//# sourceMappingURL=frequency-data.js.map