 ...
 */
const thaiTranslationProviderAdapter = {
 ...
 * ```
 */
export function createThaiTranslationExtension(nativeLanguage) {
    // Map to short language code for glost-common
    const targetLang = (nativeLanguage?.startsWith("en") ? "en" : nativeLanguage || "en");
