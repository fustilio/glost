 ...
 */
import { ThaiSyllableSegmenter, ThaiClauseSegmenter, createThaiGenderTransformer, } from "./transformers";
import { ThaiWordJoinerExtension, } from "./word-joiner";
 ...
 * ```
 */
export function createThaiPronunciationPipeline(options = {}) {
    const { nativeLanguage = "en-US", includeTranscription = true, includeTranslation = true, } = options;
    const pipeline = [];
 ...
 * ```
 */
export function createThaiDialoguePipeline(options = {}) {
    const { gender = "both", nativeLanguage = "en-US", includeSyllables = true, includeTranscription = true, includeTranslation = true, } = options;
    const pipeline = [];
 ...
 * ```
 */
export function createThaiGrammarPipeline(options = {}) {
    const { nativeLanguage = "en-US", includeSyllables = true, includeTranscription = true, includeTranslation = true, } = options;
    const pipeline = [];
 ...
 * ```
 */
export function createThaiComprehensivePipeline(options = {}) {
    const { gender = "both", nativeLanguage = "en-US", includeSyllables = true, includeGrammar = true, includeTranscription = true, includeTranslation = true, } = options;
    const pipeline = [];
