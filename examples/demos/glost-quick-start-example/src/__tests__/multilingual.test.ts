  ...
  describe("Thai Language", () => {
    ...
    it("creates a Thai greeting sentence with translations", () => {
      const words: GLOSTWord[] = [
        createThaiWord({ text: "สวัสดี", rtgs: "sa-wat-di", partOfSpeech: "interjection", tone: 2 }),
        createThaiWord({ text: "ครับ", rtgs: "khrap", partOfSpeech: "particle", tone: 2 }),
      ];
  ...
  describe("Japanese Language", () => {
    ...
    it("creates a Japanese self-introduction with translations", () => {
      const words: GLOSTWord[] = [
        ...
        createJapaneseWord({ text: "の", romaji: "no", partOfSpeech: "particle" }),
        createJapaneseWord({ text: "名前", romaji: "namae", partOfSpeech: "noun", furigana: "なまえ" }),
        createJapaneseWord({ text: "は", romaji: "wa", partOfSpeech: "particle" }),
        createJapaneseWord({ text: "田中", romaji: "Tanaka", partOfSpeech: "noun", furigana: "たなか" }),
