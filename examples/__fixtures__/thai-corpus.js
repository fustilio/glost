...
exports.thaiParagraphs = exports.thaiFoodConversation = exports.thaiDailyConversation = exports.thaiGreetings = void 0;
exports.getAllThaiSentences = getAllThaiSentences;
exports.getThaiSentencesByDifficulty = getThaiSentencesByDifficulty;
/**
 * Common Thai greetings and introductions
 */
exports.thaiGreetings = [
    {
        thai: "สวัสดีครับ",
 ...
 */
function getAllThaiSentences() {
    return [
        ...exports.thaiGreetings,
        ...exports.thaiDailyConversation,
        ...exports.thaiFoodConversation,
        ...exports.thaiParagraphs.flatMap(p => p.sentences),
    ];
}
/**
 * Get sentences by difficulty
 */
function getThaiSentencesByDifficulty(difficulty) {
    return getAllThaiSentences().filter(s => s.difficulty === difficulty);
}
//# sourceMappingURL=thai-corpus.js.map