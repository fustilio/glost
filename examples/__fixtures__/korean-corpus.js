...
exports.koreanParagraphs = exports.koreanDailyConversation = exports.koreanGreetings = void 0;
exports.getAllKoreanSentences = getAllKoreanSentences;
/**
 * Common Korean greetings
 */
exports.koreanGreetings = [
    {
        korean: "안녕하세요",
        english: "Hello",
 ...
 */
exports.koreanDailyConversation = [
    {
        korean: "잘 지냈어요",
 ...
 */
function getAllKoreanSentences() {
    return [
        ...exports.koreanGreetings,
        ...exports.koreanDailyConversation,
        ...exports.koreanParagraphs.flatMap(p => p.sentences),
    ];
}
//# sourceMappingURL=korean-corpus.js.map