 ...
 * @example
 * ```typescript
 * import { createNegationTransformerExtension } from "@glotblocks/glost-extensions/extensions";
 ...
 * @example
 * ```typescript
 * import { NegationTransformerExtension } from "@glotblocks/glost-extensions/extensions";
