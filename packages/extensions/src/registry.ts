 ...
 * @example
 * ```typescript
 * import { extensionRegistry } from "@glotblocks/glost-extensions/registry";
 * 
 ...
 * @example
 * ```typescript
 * import { registerExtension } from "@glotblocks/glost-extensions/registry";
 * 
 * registerExtension({
 *   id: "my-extension",
 *   name: "My Extension",
 ...
 * @example
 * ```typescript
 * import { registerExtensions } from "@glotblocks/glost-extensions/registry";
 * 
 * registerExtensions([
 *   ReadingScoreExtension,
 *   LearnerHintsExtension,
 ...
 * @example
 * ```typescript
 * import { getExtension } from "@glotblocks/glost-extensions/registry";
 * 
 ...
 * @example
 * ```typescript
 * import { getAllExtensions } from "@glotblocks/glost-extensions/registry";
 * 
