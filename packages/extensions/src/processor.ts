 ...
 * @since 0.7.0
 */
export async function processGLOSTChunkAsync(
  sentences: GLOSTSentence[],
  extensions: GLOSTExtension[],
  options: ProcessorOptions = {},
): Promise<GLOSTSentence[]> {
  ...
  const tempParagraph: GLOSTParagraph = {
    type: "ParagraphNode",
    children: sentences,
  } as GLOSTParagraph;

  const tempRoot: GLOSTRoot = {
    type: "RootNode",
    lang: "und",
    script: "latin",
  ...
  if (
    ...
    return para.children as GLOSTSentence[];
  }
