 ...
 */
const UNIVERSAL_POS_CATEGORIES = {
 ...
 * @internal
 */
function getPOSInfo(tag, customMappings) {
 ...
 * ```
 */
export function createPOSEnhancerExtension(options = {}) {
    ...
    return {
        ...
        enhanceMetadata: (node) => {
            ...
            const pos = node.metadata?.partOfSpeech ||
