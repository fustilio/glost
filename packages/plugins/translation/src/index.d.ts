...
export interface TranslationProvider {
     ...
     * ```
     */
    getTranslation(word: string, from: GlostLanguage, to: GlostLanguage): Promise<string | undefined>;
}
/**
 ...
 * ```
 */
export declare function createTranslationExtension(options: TranslationExtensionOptions): GLOSTExtension;
