...
export class ExtensionDependencyError extends Error {
     ...
     */
    constructor(extensionId, dependencyId, missingField, suggestion) {
        super(`Extension "${extensionId}" requires "${missingField}" from "${dependencyId}".\n${suggestion}`);
...
export class ExtensionConflictError extends Error {
     ...
     */
    constructor(field, existingExtensionId, incomingExtensionId, existingValue, incomingValue) {
        super(`Metadata conflict at "${field}": Extension "${incomingExtensionId}" ` +
        ...
        this.field = field;
        this.existingExtensionId = existingExtensionId;
        this.incomingExtensionId = incomingExtensionId;
...
export class MissingNodeTypeError extends Error {
     ...
     */
    constructor(extensionId, nodeType, suggestedExtension) {
        ...
        super(`Extension "${extensionId}" requires "${nodeType}" nodes, but none were found.\n${suggestion}`);
        this.extensionId = extensionId;
