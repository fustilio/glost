 ...
 */
import { findWord, getTranscription, getAllTranscriptions, getTranslation, } from "./helpers.js";
/**
 ...
 * ```
 */
export function createTranslationLookup(sourceLanguage, targetLanguage) {
    return async function lookupTranslation(word, _language) {
 ...
 * ```
 */
export function createTranscriptionLookup(language, system) {
    return async function lookupTranscription(word, _language) {
        // Delegates to helper (SSOT for data access)
 ...
 * ```
 */
export function createMultiSystemTranscriptionLookup(language) {
    return async function lookupMultiSystemTranscription(word, _language) {
        // Delegates to helper (SSOT for data access)
 ...
 * ```
 */
export function createCombinedLookup(sourceLanguage, targetLanguage, transcriptionSystem) {
    return {
 ...
 * ```
 */
export function createFallbackLookup(primaryLookup, fallbackLookup) {
    return async function lookupWithFallback(word, language) {
        try {
 ...
 * ```
 */
export function createEnrichedLookup(language) {
    return async function lookupEnriched(word, _language) {
        // Delegates to helper (SSOT for data access)
...
//# sourceMappingURL=lookup-functions.js.map