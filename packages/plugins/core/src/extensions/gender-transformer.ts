 ...
 * @example
 * ```typescript
 * import { createGenderTransformerExtension } from "@glotblocks/glost-plugins/extensions";
 *
 ...
 * @example
 * ```typescript
 * import { GenderTransformerExtension } from "@glotblocks/glost-plugins/extensions";
