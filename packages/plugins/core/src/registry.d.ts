 ...
 * @example
 * ```typescript
 * import { extensionRegistry } from "glost-plugins/registry";
 *
 ...
 * @since 0.0.1
 */
export declare function registerExtension(extension: GLOSTExtension): void;
/**
 * Register multiple extensions
 *
 ...
 * @example
 * ```typescript
 * import { registerExtensions } from "glost-plugins/registry";
 *
 * registerExtensions([
 *   ReadingScoreExtension,
 *   LearnerHintsExtension,
 ...
 * @since 0.0.1
 */
export declare function registerExtensions(extensions: GLOSTExtension[]): void;
/**
 * Get an extension by ID
 *
 ...
 * @example
 * ```typescript
 * import { getExtension } from "glost-plugins/registry";
 *
 ...
 * @since 0.0.1
 */
export declare function getExtension(id: string): GLOSTExtension | undefined;
/**
 * Get all registered extensions
 *
 ...
 * @example
 * ```typescript
 * import { getAllExtensions } from "glost-plugins/registry";
 *
 ...
 * @since 0.0.1
 */
export declare function getAllExtensions(): GLOSTExtension[];
export {};
