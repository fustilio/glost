 ...
 * @example
 * ```typescript
 * import { createTranslationLookup } from "@glotblocks/glost-plugins/example-data";
 ...
 * @example
 * ```typescript
 * import { createTranscriptionLookup } from "@glotblocks/glost-plugins/example-data";
 ...
 * @example
 * ```typescript
 * import { createMultiSystemTranscriptionLookup } from "@glotblocks/glost-plugins/example-data";
 * import { createTranscriptionGeneratorExtension } from "glost-plugins-transcription";
 *
 ...
 * @example
 * ```typescript
 * import { createCombinedLookup } from "@glotblocks/glost-plugins/example-data";
 * import { createTranslationGeneratorExtension } from "glost-plugins-translation";
 * import { createTranscriptionGeneratorExtension } from "glost-plugins-transcription";
 *
 ...
 * @example
 * ```typescript
 * import { createFallbackLookup, createTranscriptionLookup } from "@glotblocks/glost-plugins/example-data";
 *
 ...
 * @example
 * ```typescript
 * import { createEnrichedLookup } from "@glotblocks/glost-plugins/example-data";
 *
