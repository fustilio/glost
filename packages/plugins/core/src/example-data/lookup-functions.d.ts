 ...
 * ```
 */
export declare function createTranslationLookup(sourceLanguage: GlostLanguage, targetLanguage: GlostLanguage): (word: string, _language: GlostLanguage) => Promise<string | undefined>;
/**
 ...
 * ```
 */
export declare function createTranscriptionLookup(language: GlostLanguage, system: string): (word: string, _language: GlostLanguage) => Promise<Record<string, string>>;
/**
 ...
 * ```
 */
export declare function createMultiSystemTranscriptionLookup(language: GlostLanguage): (word: string, _language: GlostLanguage) => Promise<Record<string, string>>;
/**
 ...
 * ```
 */
export declare function createCombinedLookup(sourceLanguage: GlostLanguage, targetLanguage: GlostLanguage, transcriptionSystem: string): {
    translation: (word: string, _language: GlostLanguage) => Promise<string | undefined>;
    transcription: (word: string, _language: GlostLanguage) => Promise<Record<string, string>>;
};
/**
 ...
 * ```
 */
export declare function createFallbackLookup<T>(primaryLookup: (word: string, language: GlostLanguage) => Promise<T>, fallbackLookup: (word: string, language: GlostLanguage) => Promise<T>): (word: string, language: GlostLanguage) => Promise<T>;
/**
 ...
 * ```
 */
export declare function createEnrichedLookup(language: GlostLanguage): (word: string, _language: GlostLanguage) => Promise<Record<string, unknown>>;
//# sourceMappingURL=lookup-functions.d.ts.map