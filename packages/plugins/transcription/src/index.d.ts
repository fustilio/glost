...
import { type LogVerbosity } from "glost-utils/logger";
 ...
 * ```
 */
export declare function createTranscriptionExtension(options: TranscriptionExtensionOptions): GLOSTExtension;
