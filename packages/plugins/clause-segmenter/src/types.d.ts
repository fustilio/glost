 ...
 * Clause type
 */
export type ClauseType = "main" | "subordinate" | "relative" | "causal" | "conditional" | "temporal" | "complement" | "coordinate";
/**
 * Grammatical mood
 */
export type GrammaticalMood = "declarative" | "interrogative" | "imperative" | "conditional";
/**
...
export interface ClauseSegmenterProvider {
     ...
     */
    segmentSentence(words: string[], language: string): Promise<SegmentationResult | undefined>;
    /**
     ...
     */
    detectMood?(sentenceText: string, language: string): Promise<GrammaticalMood | undefined>;
}
