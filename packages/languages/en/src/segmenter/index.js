 ...
 * English clause segmenter provider
 */
export const englishSegmenterProvider = {
    ...
    async detectMood(sentenceText, language) {
        if (!language.startsWith("en")) {
            return undefined;
        }
 ...
 */
function detectEnglishMood(sentenceText) {
 ...
 */
export function createEnglishSegmenterProvider(customMarkers) {
