...
import { THAI_TRANSCRIPTION_SCHEMES, THAI_TRANSCRIPTION_SCHEME_NAMES, type ThaiTranscriptionScheme } from './constants.js';
 ...
 */
export declare function isValidThaiScheme(scheme: string): scheme is ThaiTranscriptionScheme;
/**
 ...
 */
export declare function getThaiSchemeDisplayName(scheme: string): string;
