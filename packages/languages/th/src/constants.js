 ...
 */
export const THAI_TRANSCRIPTION_SCHEME_NAMES = {
 ...
 * ```
 */
export function isThaiCharacter(char) {
 ...
 * ```
 */
export function containsThaiCharacters(text) {
 ...
 * ```
 */
export function isThaiText(text, allowSpaces = true) {
    if (!text)
        return false;
 ...
 * ```
 */
export function isThaiVowel(char) {
    if (!char || char.length === 0)
        return false;
    const code = char.charCodeAt(0);
 ...
 * ```
 */
export function isThaiToneMark(char) {
    if (!char || char.length === 0)
        return false;
    const code = char.charCodeAt(0);
 ...
 * ```
 */
export function getToneMark(text) {
 ...
 * ```
 */
export function getToneNumber(toneMark) {
    switch (toneMark) {
 ...
 * ```
 */
export function isValidThaiTranscriptionScheme(scheme) {
 ...
 * ```
 */
export function getThaiTranscriptionSchemeName(scheme) {
