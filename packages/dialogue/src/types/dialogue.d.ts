 ...
 */
export declare function isDialogueNode(node: unknown): node is GLOSTDialogue;
/**
 * Type guard to check if a sentence has dialogue info
 */
export declare function hasSentenceDialogueInfo(sentence: GLOSTSentence): sentence is GLOSTSentenceWithDialogue;
/**
 * Get the speaker name for a sentence
 */
export declare function getSentenceSpeaker(sentence: GLOSTSentence, participants?: DialogueParticipant[]): string | undefined;
