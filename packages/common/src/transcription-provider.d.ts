 ...
 * ```
 */
export declare function createMappingProvider<TScheme extends string>(config: MappingProviderConfig<TScheme>): TranscriptionProvider;
/**
 ...
 * ```
 */
export declare function createLookupProvider<TScheme extends string>(config: LookupProviderConfig<TScheme>): TranscriptionProvider;
/**
 ...
 * ```
 */
export declare function createFallbackProvider(providers: TranscriptionProvider[]): TranscriptionProvider;
