 ...
 */
export const ISO639_3_TO_1 = Object.fromEntries(Object.entries(ISO639_1_TO_3).map(([k, v]) => [v, k]));
/**
 ...
 */
export function toISO639_3(code) {
    if (!code)
        return code;
 ...
 */
export function toISO639_1(code) {
...
export function parseBCP47(tag) {
    ...
    const result = { language: parts[0].toLowerCase() };
    let i = 1;
 ...
 */
export function buildBCP47(components) {
    const parts = [components.language];
    if (components.script)
        parts.push(components.script);
 ...
 */
export function toBCP47WithRegion(code) {
    const iso3 = toISO639_3(code);
...
// Special Codes
// ============================================================================
export const SPECIAL_CODES = ["ipa", "und", "mul", "zxx"];
// ============================================================================
