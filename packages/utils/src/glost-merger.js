 ...
 */
function mapGLOSTDocument(document, transformWord) {
    return {
        ...document,
 ...
 */
export function mergeTranscriptionData(word, transcriptionProvider, transcriptionScheme) {
 ...
 */
export function mergeTranscriptionDataIntoDocument(document, transcriptionProvider, transcriptionScheme) {
    return mapGLOSTDocument(document, (word) => mergeTranscriptionData(word, transcriptionProvider, transcriptionScheme));
}
/**
 ...
 */
export function extendGLOSTWithMetadata(word, metadata) {
 ...
 */
export function extendGLOSTDocumentWithMetadata(document, metadataMap) {
 ...
 */
export function hydrateGLOSTDocument(document, options) {
    ...
    for (const scheme of transcriptionSchemes) {
        hydratedDocument = mergeTranscriptionDataIntoDocument(hydratedDocument, transcriptionProvider, scheme);
    }
    // Extend with metadata if provided
    if (metadataMap) {
        hydratedDocument = extendGLOSTDocumentWithMetadata(hydratedDocument, metadataMap);
    }
 ...
 */
export function filterGLOSTByGender(document, genderFilter) {
    return mapGLOSTDocument(document, (word) => {
...
//# sourceMappingURL=glost-merger.js.map