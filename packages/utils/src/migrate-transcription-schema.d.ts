 ...
 * ```
 */
export declare function migrateTranscriptionSchema(doc: GLOSTRoot, options?: MigrateTranscriptionSchemaOptions): TranscriptionMigrationResult;
/**
 ...
 */
export declare function needsTranscriptionMigration(doc: GLOSTRoot): boolean;
/**
 ...
 */
export declare function analyzeTranscriptionMigration(doc: GLOSTRoot): TranscriptionMigrationResult;
//# sourceMappingURL=migrate-transcription-schema.d.ts.map