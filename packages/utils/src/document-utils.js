 ...
 */
import { getWordsFromDocument, getFirstSentence as getFirstSentenceFromGLOST, getWordsFromSentence, getSentenceTranslation as getSentenceTranslationFromGLOST, } from "glost";
/**
 * Extract all words from an GLOST document
 *
 * Re-exports getWordsFromDocument from glost for consistency.
 */
export function getAllWordsFromDocument(doc) {
 ...
 */
export function getFirstSentenceFromDocument(doc) {
    return getFirstSentenceFromGLOST(doc);
}
/**
 * Get words from the first sentence
 */
export function getWordsFromFirstSentence(doc) {
 ...
 */
export function getDocumentTranscriptionSystems(doc) {
 ...
 */
export function hasTranscriptionData(doc) {
    const words = getAllWordsFromDocument(doc);
 ...
 */
export function getDocumentMetadata(doc) {
    return {
        language: doc.lang,
        script: doc.script,
