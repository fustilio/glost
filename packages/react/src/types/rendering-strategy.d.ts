...
export interface LanguageRenderingStrategy {
     ...
     */
    shouldHideTranscription?: (word: GLOSTWord, transcriptionSystem: string) => boolean;
    /**
     * Get the position for transcription display
     */
    getTranscriptionPosition?: (word: GLOSTWord, transcriptionSystem: string) => "above" | "below";
    /**
     * Get additional CSS class for transcription
     */
    getTranscriptionClassName?: (word: GLOSTWord, transcriptionSystem: string) => string;
    /**
     * Get ruby annotation position
     */
    getRubyPosition?: (word: GLOSTWord, transcriptionSystem: string) => RubyPosition;
    /**
     * Determine if transcription should be shown for this word
     * This is the preferred method over shouldHideTranscription
     */
    shouldShowTranscription?: (word: GLOSTWord, transcriptionSystem: string) => boolean;
    /**
     * Get placeholder content when transcription is hidden
     * Used to maintain consistent spacing
     */
    getTranscriptionPlaceholder?: (word: GLOSTWord, transcriptionSystem: string) => string;
}
/**
 * Default rendering strategy with sensible defaults
 */
export declare const defaultRenderingStrategy: LanguageRenderingStrategy;
/**
 * Create a rendering strategy by merging with defaults
 */
export declare function createRenderingStrategy(overrides: Partial<LanguageRenderingStrategy>): LanguageRenderingStrategy;
//# sourceMappingURL=rendering-strategy.d.ts.map