import { createGLOSTWordNode, createGLOSTSentenceNode, createGLOSTParagraphNode, createGLOSTRootNode } from 'glost-core';
// ============================================================================
// Enhanced Thai Example with Extras
// ============================================================================
const thaiWordsWithExtras = [
    createGLOSTWordNode({
        value: 'สวัสดี',
        transcription: {
            rtgs: {
 ...
 */
export function getQuickTranslation(word, targetLang) {
    return word.extras?.translations?.[targetLang];
}
/**
 * Get all available translations for a word
 */
export function getAllTranslations(word) {
 ...
 */
export function getCulturalNotes(word) {
