...
- `glost-plugins` - Extension system and built-in extensions
...
- [Transcription Providers](/docs/guides/implementing-transcription-providers) - Provider implementation patterns
...
**Adopted Standards:**
- [Metadata Schema v1](/docs/standards/metadata-schema)
- [Transcription Provider Patterns](/docs/guides/implementing-transcription-providers)
- [Naming Conventions](/docs/conventions/naming)
- [SRP/SSOT Architecture](/docs/architecture-summary)
...
| `glost-plugins` | Extension system | Active |
...
- **Documentation:** [Getting Started](/docs/getting-started), [Core Concepts](/docs/concepts/nodes), [Plugin System](/docs/concepts/plugins)
- **Community:** GitHub Issues for bugs and features, GitHub Discussions for questions
- **Examples:** See [examples](https://github.com/fustilio/glost/tree/main/examples) on GitHub
...
- [Examples](https://github.com/fustilio/glost/tree/main/examples)
