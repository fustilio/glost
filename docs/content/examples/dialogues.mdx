...
```bash
npm install @glotblocks/glost-dialogue @glotblocks/glost @glotblocks/glost-react
```
...
```tsx
import { DialogueContainer, DialogueTurn } from "@glotblocks/glost-dialogue/react";
...
```typescript
import { isDialogueNode, hasSentenceDialogueInfo } from "@glotblocks/glost-dialogue";
