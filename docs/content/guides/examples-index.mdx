...
3. **[Extensions API Example](../../examples/demos/glost-plugins-api-example/)** - Extension patterns
...
| [Extensions API](../../examples/demos/glost-plugins-api-example/) | Extension system usage | Composition, Plugins |
...
→ Study [Extensions API Example](../../examples/demos/glost-plugins-api-example/)
