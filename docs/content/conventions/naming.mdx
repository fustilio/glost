...
| `@glotblocks/glost-common` | Shared utilities and language codes | Language info, validators |
| `@glotblocks/glost-utils` | Text parsing and manipulation | Text utilities, parsers |
| `@glotblocks/glost-plugins` | Extension system | Extension interface, processor |
...
|------|---------|---------|
| Core package | `glost-[name]` | `@glotblocks/glost-common` |
