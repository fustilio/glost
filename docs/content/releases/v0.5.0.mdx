...
**Base Classes** (`@glotblocks/glost-common`):
...
- **`@glotblocks/glost-core`** - Core types and nodes (renamed from `glost`)
- **`@glotblocks/glost-processor`** - Processor API (new)
- **`@glotblocks/glost-registry`** - Plugin registry (new)
- **`@glotblocks/glost-presets`** - Preset configurations (new)
- **`@glotblocks/glost-cli`** - CLI tools (new)
- **`@glotblocks/glost-common`** - Enhanced with provider base classes and data loaders
...
- **After:** `@glotblocks/glost-core` (core implementation), `glost` (facade package)
...
- [Implementing Language Providers](/docs/guides/implementing-language-providers) ⭐ NEW
