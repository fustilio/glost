...
```bash
pnpm add @glotblocks/glost-plugins
```

## Overview

`@glotblocks/glost-plugins` provides the core extension infrastructure:
...
```typescript
import { createClauseAnalysisExtension } from '@glotblocks/glost-plugins';
...
| `@glotblocks/glost-gender` | Grammatical gender | `pnpm add @glotblocks/glost-gender` |
