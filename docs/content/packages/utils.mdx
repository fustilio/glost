...
```bash
pnpm add @glotblocks/glost-utils
```
...
// Subpath exports
import { convertTextToGLOST } from '@glotblocks/glost-utils/text-to-glost';
import { mergeTranscriptionData } from '@glotblocks/glost-utils/merger';
import { getAllWordsFromDocument } from '@glotblocks/glost-utils/document';
import { convertScriptToString } from '@glotblocks/glost-utils/script';
```
...
```typescript
import { convertTextToGLOST } from '@glotblocks/glost-utils';
