...
```bash
pnpm add @glotblocks/glost-transcription
```
...
```typescript
import { createTranscriptionPlugin } from '@glotblocks/glost-transcription';
...
import { createTranslationGeneratorExtension } from '@glotblocks/glost-translation';
