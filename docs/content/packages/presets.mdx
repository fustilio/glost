...
```bash
npm install @glotblocks/glost-presets @glotblocks/glost-core @glotblocks/glost-processor
```
...
```typescript
import type { Preset } from '@glotblocks/glost-presets';
...
```typescript
import type { Preset, PresetOptions } from '@glotblocks/glost-presets';
```
