...
**Documentation:** [Processor API Guide](./guides/processor-api)
...
**Documentation:** [Registry Guide](./guides/registry)
...
**Documentation:** [CLI README](../packages/cli/README)
...
**Documentation:** [Presets README](../packages/presets/README)
...
See the [Migration Guide](./migration/MIGRATION_v0.4_to_v0.5) for detailed migration instructions.
...
- [Migration Guide](./migration/MIGRATION_v0.4_to_v0.5)
- [Processor API Guide](./guides/processor-api)
- [Registry Guide](./guides/registry)
- [Package Refactoring](./PACKAGE_REFACTORING)
