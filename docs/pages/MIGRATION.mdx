...
**See:** [Migration Guide v0.4 to v0.5](./migration/MIGRATION_v0.4_to_v0.5)
...
- [Full Migration Guide](./migration/MIGRATION_v0.4_to_v0.5) - Complete details and examples
- [Release Notes](./releases/RELEASE_NOTES_v0.5.0) - What's new in v0.5.0
- [Extensions Guide](./EXTENSIONS_GUIDE) - Working with the extension system
- [Provider Philosophy](./PROVIDER_PHILOSOPHY) - Understanding data quality principles
