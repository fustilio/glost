...
- [Transcription Providers](./guides/implementing-transcription-providers) - Provider implementation patterns
...
**Adopted Standards:**
- [Metadata Schema v1](./standards/metadata-schema)
- [Transcription Provider Patterns](./guides/implementing-transcription-providers)
- [Naming Conventions](./conventions/naming)
- [SRP/SSOT Architecture](./ARCHITECTURE_SUMMARY)
...
- **Documentation:** [Getting Started](./getting-started), [Core Concepts](./concepts/nodes), [Extension System](./concepts/extensions)
